      ...
      <div class="col-md-12">
        <section class="news">
            ...
            <div class="col-12 col-lg-8">
              <div class="p-1 bg-light rounded rounded-pill shadow-sm mb-4">
                <div class="input-group">
                  <input type="search" placeholder='Cari "PPD" atau "Knowledge Sharing"'
                    aria-describedby="button-addon1" class="form-control border-0" style="border-radius: 27px"
                    id="news_search" />
          ...
          <?php foreach ($articles as $article) { ?>
            <a data-id="<?php echo $article->id ?>" target="_blank" rel="noopener"
              href="<?php base_url(); ?>news/<?php echo $article->slug ?>" title="<?php echo $article->title ?>">
              <div class="news-list-content-card card card-article mb-3">
                <div class="row no-gutters">
                  <div class="col-md-5">
                    <img class="w-100 img-news"
                    ...
                    <div class="card-body">
                      <p class="card-text">
                        <small class="text-muted">
                          <?php echo date("j F Y", strtotime(substr($article->created_at, 0, 10))) ?>
                        </small>
                      ...
                      <p class="card-text text-news">
                        ...
                        <br /><button type="button" class="button-read-more btn-read-more-article"
                          data-id="<?php echo $article->id ?>" target="_blank" rel="noopener"
                          href="<?php base_url(); ?>news/<?php echo $article->slug ?>"
                          title="<?php echo $article->title ?>">Selengkapnya...</button>
                      </p>
                    </div>
                  </div>
                </div>
