    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php if (isset($IndikatorTable)) { ?>
                    <form id="formSearchIndicatorModal" method="get" action="<?php base_url('infograph') ?>">
                        <div class="card-body" style="height: 300px; padding-top: 0.5rem; padding-bottom: 0.5rem;">
                            <div class="form-group" style="margin-bottom: 0.5rem;">
                                <label for="indikator">Indikator</label>
    ...
    $('#selectWilayah').on('change', function() {
        ...
        if (this.value == 'provinsi') {
            ...
            $.get("https://webapi.bps.go.id/v1/api/domain/type/prov/key/24fb1b646304e23577aaad005eb40714/", function(data) {
                ...
                $("#selectSubWilayahModal").html(txt);
            });
            ...
            $(".form-group-sub-wilayah-modal").show();
            $("#selectSubWilayah-modal").prop('required', true);
            $(".form-group-kabupaten-kota-modal").hide();
            $("#selectKabupatenKota-modal").prop('required', false);
