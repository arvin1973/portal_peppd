...
<script
    src="<?= base_url(); ?>assets/js/summernote/summernote-image-attributes-master/summernote-image-attributes.js"></script>
...
<script
    src="<?= base_url(); ?>assets/js/summernote/summernote-image-captionit-master/summernote-image-captionit.js"></script>
<script
    src="<?= base_url(); ?>assets/js/summernote/summernote-list-styles-master/summernote-list-styles-bs4.js"></script>
<script
    src="<?= base_url(); ?>assets/js/summernote/summernote-table-headers-master/summernote-table-headers.js"></script>
...
<script
    src="<?= base_url(); ?>assets/js/summernote/summernote-ext-table-master/script/summernote/plugin/table/summernote-ext-table.js"></script>
<script
    src="<?= base_url(); ?>assets/js/summernote/summernote-ext-codewrapper-master/dist/summernote-ext-codewrapper.min.js"></script>
<script
    src="<?= base_url(); ?>assets/js/summernote/summernote-ext-highlight-master/src/summernote-ext-highlight.js"></script>
...
<script src="<?= base_url() ?>assets/plugins/owlcarousel2/dist/owl.carousel.min.js"></script>
