          ...
          click: function () {
            ...
            if ($parentAnchorLink.parent('figure').length) {
              ...
              if ($parentAnchorLink.is('a')) {
                ...
                $newFigure.append('<figcaption class="' + options.captionIt.figcaptionClass + '" style="text-align: center"><font color="#000000">' + captionText + '</font></figcaption>');
                
              } else {
                $newFigure = img.wrap('<figure class="' + options.captionIt.figureClass + '"></figure>').parent();
                img.after('<figcaption class="' + options.captionIt.figcaptionClass + '" style="text-align: center"><font color="#000000">' + captionText + '</font></figcaption>');
