            ...
            <div class="card-body">
                <div class="text-left">
                    <table style="width:100%; border: 0px solid black">
                        ...
                        <tr style=" border: 0px solid black">
                            <td style="width:60px; border: 0px solid black; font-size: 14px; font-weight: bold;"></td>
            ...
            <div class="list_penilai_dok">
                    ...
                    <table style="width:100%;">
                        <tr style="">
                          ...
                          <td style="width:800px;"><?php //echo $this->session->userdata(SESSION_LOGIN)->userid; 
                                                    ?></td>
                          <td></td>
                        </tr>
                        <tr>
                          ...
                          <td>:</td>
                          <td><?php //echo $this->session->userdata(SESSION_LOGIN)->name; 
                                ?></td>
                          <td></td>
                        </tr>
                    </table>
                        ...
                        <div class="card-body" style='text-align: justify'>
                            <div class="custom-accordion" id="accordionborder">
                                    ...
                                    <div id="customborder_collapsefour" class="collapse show" aria-labelledby="customborder_headingfour" data-parent="#accordionborder" style="">
                                        <div class="card-body">
                                            <video width="390" height="240" style="width: 100%; height: 100%;" controls>
                                                <source src="<?= base_url() ?>assets/video_tutorial_3/tpitpu/modul 2_Trim_tpitpu.mp4" type="video/mp4">
                                ...
                                <div class="card mb-1 shadow-none border">
                                    ...
                                    <div id="customborder_collapseseven" class="collapse" aria-labelledby="customborder_headingseven" data-parent="#accordionborder">
                                        <div class="card-body">
                                            <video width="390" height="240" style="width: 100%; height: 100%;" controls>
                                                <source src="<?= base_url() ?>assets/video_tutorial_3/tpitpu/modul_3_tpitpu.webm" type="video/mp4">
                                                Your browser does not support the video tag.
                                            </video>
                                        </div>
                                    </div>
                                ...
                                <div class="card mb-1 shadow-none border">
                                    ...
                                    <div id="customborder_collapsesix" class="collapse" aria-labelledby="customborder_headingsix" data-parent="#accordionborder">
                                        <div class="card-body">
                                            <video width="390" height="240" style="width: 100%; height: 100%;" controls>
                                                <source src="<?= base_url() ?>assets/video_tutorial_3/tpitpu/bahan_dukung_tpitpu.webm" type="video/mp4">
                                                Your browser does not support the video tag.
                                            </video>
                                        </div>
                                    </div>
                                ...
                                <div class="card mb-1 shadow-none border">
                                    ...
                                    <div id="customborder_collapsefive" class="collapse" aria-labelledby="customborder_headingfive" data-parent="#accordionborder">
                                        <div class="card-body">
                                            <video width="390" height="240" style="width: 100%; height: 100%;" controls>
                                                <source src="<?= base_url() ?>assets/video_tutorial_3/tpitpu/dokumen_daerahtpitpu.webm" type="video/mp4">
                                                Your browser does not support the video tag.
                                            </video>
                                        </div>
                                    </div>
