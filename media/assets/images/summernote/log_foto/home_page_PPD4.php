...
<!-- <div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title">Penghargaan Pembangunan Daerah 2021 </h4>
...
<div class="row" style="margin-top: 90px;">
    <div class="col-lg-12">
        <div class="card" style="border: 1px solid rgba(49, 126, 235, 1);">
            <div class="avatar-lg bg-info rounded-circle mr-2" style="position: absolute; height: 5.5rem; width: 5.5rem; top: 30px; right: 15px; background-color: rgba(49, 126, 235, 0.2) !important; border: 2px solid rgba(41,182,246, 0.5)">
            ...
            <div class="card-body">
                <div class="text-left">
                    <table style="width:100%;  border: 0px solid black">
                        ...
                        <tr style=" border: 0px solid black">
                            <td style="width:60px; border: 0px solid black; font-size: 14px; font-weight: bold;">Provinsi </td>
                            <!-- <td >:</td> -->
                            <td style=" border: 0px solid black; font-size: 14px;" name="note">: &nbsp; <?php echo $home_properties["satker_name"]; ?> </td>
                        </tr>
                    </table>
                </div>
            </div>
                            ...
                            <div class="custom-accordion" id="accordionborder">
                                    ...
                                    <a href="" class="text-dark collapsed" data-toggle="collapse" data-target="#customborder_collapsefour" aria-expanded="true" aria-controls="customborder_collapsefour">
                                        <div class="card-header" id="customborder_headingfour">
                                            <h5 class="card-title m-0">
                                                Tambah dan Ubah Pengguna Kabupaten/ Kota
                                    ...
                                    <div id="customborder_collapsefour" class="collapse show" aria-labelledby="customborder_headingfour" data-parent="#accordionborder" style="">
                                        <div class="card-body">
                                            <video width="390" height="240" style="width: 100%; height: 100%;" controls>
                                                <source src="<?= base_url() ?>assets/video_tutorial_3/provinsi/tambah_edit_user_kabkota_provinsi.webm" type="video/mp4">
                                ...
                                <div class="card mb-1 shadow-none border">
                                    <a href="" class="text-dark collapsed" data-toggle="collapse" data-target="#customborder_collapsefive" aria-expanded="false" aria-controls="customborder_collapsefive">
                                        <div class="card-header" id="customborder_headingfive">
                                            <h5 class="card-title m-0">
                                                Reset Password Pengguna Kabupaten/ Kota
                                    ...
                                    <div id="customborder_collapsefive" class="collapse" aria-labelledby="customborder_headingfive" data-parent="#accordionborder">
                                        <div class="card-body">
                                            <video width="390" height="240" style="width: 100%; height: 100%;" controls>
                                                <source src="<?= base_url() ?>assets/video_tutorial_3/provinsi/reset_password_kabkota_provinsi.webm" type="video/mp4">
                                                Your browser does not support the video tag.
                                            </video>
                                        </div>
                                    </div>
                                ...
                                <!-- <div class="card mb-0 shadow-none border">
                                    ...
                                    <div id="customborder_collapsesix" class="collapse" aria-labelledby="customborder_headingsix" data-parent="#accordionborder" style="">
                                        <div class="card-body">
                                            <video width="390" height="240" style="width: 100%; height: 100%;" controls>
                                                <source src="<?= base_url() ?>assets/video_tutorial_2/provinsi/hapus_user_kabkota.mp4" type="video/mp4">
                                                Your browser does not support the video tag.
                                            </video>
                                        </div>
                                    </div>
                                ...
                                <div class="card mb-0 shadow-none border">
                                    ...
                                    <div id="customborder_collapseseven" class="collapse" aria-labelledby="customborder_headingseven" data-parent="#accordionborder" style="">
                                        <div class="card-body">
                                            <video width="390" height="240" style="width: 100%; height: 100%;" controls>
                                                <source src="<?= base_url() ?>assets/video_tutorial_3/provinsi/upload_tambah_edit_hapus_dokumen_provinsi.webm" type="video/mp4">
                                                Your browser does not support the video tag.
                                            </video>
                                        </div>
                                    </div>
                                ...
                                <!-- <div class="card mb-0 shadow-none border">
                                    <a href="" class="text-dark collapsed" data-toggle="collapse" data-target="#customborder_collapseeight" aria-expanded="false" aria-controls="customborder_collapseeight">
                                        <div class="card-header" id="customborder_headingeight">
                                            <h5 class="card-title m-0">
                                                Upload Dokumen Kota
                                                <i class="mdi mdi-minus-circle-outline float-right accor-plus-icon"></i>
                                            </h5>
                                    ...
                                    <div id="customborder_collapseeight" class="collapse" aria-labelledby="customborder_headingeight" data-parent="#accordionborder" style="">
                                        <div class="card-body">
                                            <video width="390" height="240" style="width: 100%; height: 100%;" controls>
                                                <source src="<?= base_url() ?>assets/video_tutorial_2/provinsi/unduh_atau_tambah_dokumen_kota.mp4" type="video/mp4">
                                                Your browser does not support the video tag.
                                            </video>
                                        </div>
                                    </div>
                                ...
                                <div class="card mb-0 shadow-none border">
                                    <a href="" class="text-dark collapsed" data-toggle="collapse" data-target="#customborder_collapsenine" aria-expanded="false" aria-controls="customborder_collapsenine">
                                        <div class="card-header" id="customborder_headingnine">
                                            <h5 class="card-title m-0">
                                                Upload Dokumen Kabupaten
                                                <i class="mdi mdi-minus-circle-outline float-right accor-plus-icon"></i>
                                            </h5>
                                        </div>
                                    </a>
                                        
                                    <div id="customborder_collapsenine" class="collapse" aria-labelledby="customborder_headingnine" data-parent="#accordionborder" style="">
                                        <div class="card-body">
                                            <video width="390" height="240" style="width: 100%; height: 100%;" controls>
                                                <source src="<?= base_url() ?>assets/video_tutorial_2/provinsi/unduh_atau_tambah_dokumen_kabupaten.mp4" type="video/mp4">
                                                Your browser does not support the video tag.
                                            </video>
                                        </div>
                                    </div>
                                ...
                                <div class="card mb-0 shadow-none border">
                                    <a href="" class="text-dark collapsed" data-toggle="collapse" data-target="#customborder_collapseeleven" aria-expanded="false" aria-controls="customborder_collapseeleven">
                                        <div class="card-header" id="customborder_headingeleven">
                                            <h5 class="card-title m-0">
                                    ...
                                    <div id="customborder_collapseeleven" class="collapse" aria-labelledby="customborder_headingeleven" data-parent="#accordionborder" style="">
                                        <div class="card-body">
                                            <video width="390" height="240" style="width: 100%; height: 100%;" controls>
                                                <source src="<?= base_url() ?>assets/video_tutorial_3/provinsi/hasil_penilaian_provinsi.webm" type="video/mp4">
                                                Your browser does not support the video tag.
                                            </video>
                                        </div>
                                    </div>
                                ...
                                <div class="card mb-0 shadow-none border">
                                    <a href="" class="text-dark collapsed" data-toggle="collapse" data-target="#customborder_collapseten" aria-expanded="false" aria-controls="customborder_collapseten">
                                        <div class="card-header" id="customborder_headingten">
                                            <h5 class="card-title m-0">
                                                Bahan Dukung Provinsi
                                                <i class="mdi mdi-minus-circle-outline float-right accor-plus-icon"></i>
                                            </h5>
                                        </div>
                                    </a>

                                    <div id="customborder_collapseten" class="collapse" aria-labelledby="customborder_headingten" data-parent="#accordionborder" style="">
                                        <div class="card-body">
                                            <video width="390" height="240" style="width: 100%; height: 100%;" controls>
                                                <source src="<?= base_url() ?>assets/video_tutorial_3/provinsi/bahan_dukung_provinsi.webm" type="video/mp4">
                                                Your browser does not support the video tag.
                                            </video>
                                        </div>
                                    </div>
                                ...
                                <div class="card mb-0 shadow-none border">
                                    ...
                                    <div id="customborder_collapsetwelve" class="collapse" aria-labelledby="customborder_headingtwelve" data-parent="#accordionborder" style="">
                                        <div class="card-body">
                                            <video width="390" height="240" style="width: 100%; height: 100%;" controls>
                                                <source src="<?= base_url() ?>assets/video_tutorial_3/ubah_password.webm" type="video/mp4">
                                                Your browser does not support the video tag.
                                            </video>
                                        </div>
                                    </div>
        ...
        <!-- <div class="row">
            <div class="col-12">
                <div class="card card-border">
                    ...
                    <div class="card-body" style='text-align: justify'>
                        <p><strong>Penghargaan Pembangunan Daerah (PPD)</strong> adalah penghargaan yang diberikan oleh pemerintah pusat, dalam hal ini Kementerian Perencanaan Pembangunan Nasional/ Badan Perencanaan Pembangunan Nasional, kepada pemerintah daerah yang menunjukkan prestasi dalam perencanaan, pencapaian dan inovasi pembangunan daerah terbaik. Penghargaan ini diberikan kepada provinsi, kabupaten, dan kota.</p>
                        <span>Tujuan pelaksanaan PPD yaitu:</span>
                        <ul class="mb-0">
                            <li>Mendorong pemerintah daerah untuk menyusun dokumen perencanaan yang konsisten, komprehensif, terukur, dan dapat dilaksanakan.</li>
                            <li>Mendorong integrasi, sinkronisasi, dan sinergi antara perencanaan pusat dan daerah.</li>
