            ...
            <div class="card-body">
                <div class="text-left">
                    <table style="width:100%;  border: 0px solid black">
                        ...
                        <tr style=" border: 0px solid black">
                            <td style="width:70px; border: 0px solid black; font-size: 14px;">Kab/Kota </td>
                            <!-- <td >:</td> -->
                            <td style=" border: 0px solid black; font-size: 14px;" name="note">: &nbsp; <?php echo $home_properties["satker_kbko"]; ?> </td>
                        </tr>
                    </table>
                </div>
            </div>
                    ...
                    <div class="custom-accordion" id="accordionborder">
                            ...
                            <div id="customborder_collapsefour" class="collapse show" aria-labelledby="customborder_headingfour" data-parent="#accordionborder" style="">
                                <div class="card-body">
                                    <video width="390" height="240" style="width: 100%; height: 100%;" controls>
                                        <source src="<?= base_url() ?>assets/video_tutorial_3/kabkota/upload_dokumen_kabkota.webm" type="video/mp4">
                        ...
                        <div class="card mb-1 shadow-none border">
                            ...
                            <div id="customborder_collapsefive" class="collapse" aria-labelledby="customborder_headingfive" data-parent="#accordionborder">
                                <div class="card-body">
                                    <video width="390" height="240" style="width: 100%; height: 100%;" controls>
                                        <source src="<?= base_url() ?>assets/video_tutorial_3/kabkota/bahan_dukung_kabkota.webm" type="video/mp4">
                                        Your browser does not support the video tag.
                                    </video>
                                </div>
                            </div>
